...
_result = 0;
_missionMarkerName = "Tank_Marker";
...
_vehicleClass = ["B_APC_Tracked_01_rcws_F","O_APC_Tracked_02_cannon_F","O_MBT_02_arty_F","B_APC_Tracked_01_crv_F","B_APC_Tracked_01_AA_F","B_MBT_01_cannon_F","B_MBT_01_arty_F","B_MBT_01_mirs_F","O_MBT_02_Cannon_f","O_APC_Tracked_02_aa_f"] call BIS_fnc_selectRandom;

//Vehicle Class, Posistion, Fuel, Ammo, Damage, State
_vehicle = [_vehicleClass,_randomPos,0,0,0.75,"NONE"] call createMissionVehicle;
