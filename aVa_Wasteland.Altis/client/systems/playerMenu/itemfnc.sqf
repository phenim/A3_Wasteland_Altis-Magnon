...
switch(_switch) do 
{
	...
	case 1: //Drop item
	{
		...
		switch(_data) do 
		{
			...
			case "repairkits": {player setVariable["repairkits", (player getvariable "repairkits")-1,true]; _temp = "Land_ExtensionCord_F" createVehicle (position player); _temp setPos _pos;};
			...
			case "medkit": {player setVariable["medkits", (player getvariable "medkits")-1,true]; _temp = "Land_Suitcase_F" createVehicle (position player); _temp setPos _pos;};
