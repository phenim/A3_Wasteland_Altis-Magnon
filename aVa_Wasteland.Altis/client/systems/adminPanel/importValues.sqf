...
#define playerMenuPlayerPunish 55510
...
if ((_uid in moderators) OR (_uid in administrators) OR (_uid in serverAdministrators)) then {
	...
	_punishText = _dialogPlayer displayCtrl playerMenuPlayerPunish;
	...
	if (_type1 == 2) then {
	    ...
	    {
	        if (str(_x) == _data1) exitwith {
	            _itemsText ctrlSetText format["Weapons: %1",weapons _x];
				...
				_punishText ctrlSetText format["Punish: %1",_x getVariable "PunishZahl"];
